...
export const toolbarKeyToMenu = (toolbar: Array<string | IMenuItem>) => {
    const toolbarItem: IMenuItem [] = [{
        name: "block-ref",
        hotkey: window.shehab.config.keymap.editor.insert.ref.custom,
        lang: "ref",
        icon: "iconRef",
        tipPosition: "ne",
    }, {
        name: "a",
        hotkey: window.shehab.config.keymap.editor.insert.link.custom,
        lang: "link",
        icon: "iconLink",
        tipPosition: "n",
    }, {
        name: "strong",
        lang: "bold",
        hotkey: window.shehab.config.keymap.editor.insert.bold.custom,
        icon: "iconBold",
        tipPosition: "n",
    }, {
        name: "em",
        lang: "italic",
        hotkey: window.shehab.config.keymap.editor.insert.italic.custom,
        icon: "iconItalic",
        tipPosition: "n",
    }, {
        name: "u",
        lang: "underline",
        hotkey: window.shehab.config.keymap.editor.insert.underline.custom,
        icon: "iconUnderline",
        tipPosition: "n",
    }, {
        name: "s",
        lang: "strike",
        hotkey: window.shehab.config.keymap.editor.insert.strike.custom,
        icon: "iconStrike",
        tipPosition: "n",
    }, {
        name: "mark",
        lang: "mark",
        hotkey: window.shehab.config.keymap.editor.insert.mark.custom,
        icon: "iconMark",
        tipPosition: "n",
    }, {
        name: "sup",
        lang: "sup",
        hotkey: window.shehab.config.keymap.editor.insert.sup.custom,
        icon: "iconSup",
        tipPosition: "n",
    }, {
        name: "sub",
        lang: "sub",
        hotkey: window.shehab.config.keymap.editor.insert.sub.custom,
        icon: "iconSub",
        tipPosition: "n",
    }, {
        name: "kbd",
        lang: "kbd",
        hotkey: window.shehab.config.keymap.editor.insert.kbd.custom,
        icon: "iconKeymap",
        tipPosition: "n",
    }, {
        name: "tag",
        lang: "tag",
        hotkey: window.shehab.config.keymap.editor.insert.tag.custom,
        icon: "iconTags",
        tipPosition: "n",
    }, {
        name: "code",
        lang: "inline-code",
        hotkey: window.shehab.config.keymap.editor.insert["inline-code"].custom,
        icon: "iconInlineCode",
        tipPosition: "n",
    }, {
        name: "inline-math",
        lang: "inline-math",
        hotkey: window.shehab.config.keymap.editor.insert["inline-math"].custom,
        icon: "iconMath",
        tipPosition: "n",
    }, {
        name: "inline-memo",
        lang: "memo",
        hotkey: window.shehab.config.keymap.editor.insert.memo.custom,
        icon: "iconM",
        tipPosition: "n",
    }, {
        name: "text",
        lang: "appearance",
        hotkey: window.shehab.config.keymap.editor.insert.appearance.custom,
        icon: "iconFont",
        tipPosition: "n",
    }, {
        name: "clear",
        lang: "clearInline",
        hotkey: window.shehab.config.keymap.editor.insert.clearInline.custom,
        icon: "iconClear",
        tipPosition: "n",
    }, {
        name: "|",
