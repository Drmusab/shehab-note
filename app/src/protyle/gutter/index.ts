...
export class Gutter {
    ...
    constructor(protyle: IProtyle) {
        if (isMac()) {
            this.gutterTip = window.shehab.languages.gutterTip.replace("⌥→", updateHotkeyAfterTip(window.shehab.config.keymap.general.enter.custom, "/"))
                .replace("⌘↑", updateHotkeyAfterTip(window.shehab.config.keymap.editor.general.collapse.custom, "/"))
                .replace("⌥⌘A", updateHotkeyAfterTip(window.shehab.config.keymap.editor.general.attr.custom, "/"));
        } else {
            this.gutterTip = window.shehab.languages.gutterTip.replace("⌥→", updateHotkeyAfterTip(window.shehab.config.keymap.general.enter.custom, "/"))
                .replace("⌘↑", updateHotkeyAfterTip(window.shehab.config.keymap.editor.general.collapse.custom, "/"))
                .replace("⌥⌘A", updateHotkeyAfterTip(window.shehab.config.keymap.editor.general.attr.custom, "/"))
        ...
        if (protyle.options.backlinkData) {
            this.gutterTip = this.gutterTip.replace(window.shehab.languages.enter, window.shehab.languages.openBy);
        }
        ...
        this.element.addEventListener("click", (event: MouseEvent & { target: HTMLInputElement }) => {
            ...
            if (isOnlyMeta(event)) {
            ...
            } else if (!window.shehab.ctrlIsPressed && !window.shehab.altIsPressed && !window.shehab.shiftIsPressed) {
                ...
                /// #else
                window.shehab.menus.menu.popup({x: gutterRect.left, y: gutterRect.bottom, isLeft: true});
                const popoverElement = hasTopClosestByClassName(protyle.element, "block__popover", true);
                window.shehab.menus.menu.element.setAttribute("data-from", popoverElement ? popoverElement.dataset.level + "popover" : "app");
        ...
        this.element.addEventListener("contextmenu", (event: MouseEvent & { target: HTMLInputElement }) => {
            ...
            if (!window.shehab.ctrlIsPressed && !window.shehab.altIsPressed && !window.shehab.shiftIsPressed) {
                hideTooltip();
                clearSelect(["av", "img"], protyle.wysiwyg.element);
                const gutterRect = buttonElement.getBoundingClientRect();
    ...
    public isMatchNode(item: Element) {
        ...
        if (itemRect.height < Math.floor(window.shehab.config.editor.fontSize * 1.625) + 8) {
    ...
    public renderMultipleMenu(protyle: IProtyle, selectsElement: Element[]) {
        ...
        if (!isList && !protyle.disabled) {
            ...
            if (isContinue) {
                turnIntoSubmenu.push(this.turnsIntoOne({
                    menuId: "list",
                    icon: "iconList",
                    label: window.shehab.languages.list,
                    protyle,
                    accelerator: window.shehab.config.keymap.editor.insert.list.custom,
                    selectsElement,
                    type: "Blocks2ULs"
                }));
                turnIntoSubmenu.push(this.turnsIntoOne({
                    ...
                    label: window.shehab.languages["ordered-list"],
                    accelerator: window.shehab.config.keymap.editor.insert["ordered-list"].custom,
                    protyle,
                    selectsElement,
                    type: "Blocks2OLs"
                }));
                turnIntoSubmenu.push(this.turnsIntoOne({
                    menuId: "check",
                    icon: "iconCheck",
                    label: window.shehab.languages.check,
                    accelerator: window.shehab.config.keymap.editor.insert.check.custom,
                    protyle,
                    selectsElement,
                    type: "Blocks2TLs"
                }));
                turnIntoSubmenu.push(this.turnsIntoOne({
                    menuId: "quote",
                    icon: "iconQuote",
                    label: window.shehab.languages.quote,
                    accelerator: window.shehab.config.keymap.editor.insert.quote.custom,
                    protyle,
                    selectsElement,
                ...
                turnIntoSubmenu.push(this.turnsIntoOne({
                    menuId: "callout",
                    icon: "iconCallout",
                    label: window.shehab.languages.callout,
                    protyle,
                    selectsElement,
                    type: "Blocks2Callout"
                }));
            ...
            turnIntoSubmenu.push(this.turnsInto({
                menuId: "paragraph",
                icon: "iconParagraph",
                label: window.shehab.languages.paragraph,
                accelerator: window.shehab.config.keymap.editor.heading.paragraph.custom,
                protyle,
                selectsElement,
                type: "Blocks2Ps",
                isContinue
            ...
            turnIntoSubmenu.push(this.turnsInto({
                menuId: "heading1",
                icon: "iconH1",
                label: window.shehab.languages.heading1,
                accelerator: window.shehab.config.keymap.editor.heading.heading1.custom,
                protyle,
                selectsElement,
                level: 1,
                type: "Blocks2Hs",
            ...
            turnIntoSubmenu.push(this.turnsInto({
                menuId: "heading2",
                icon: "iconH2",
                label: window.shehab.languages.heading2,
                accelerator: window.shehab.config.keymap.editor.heading.heading2.custom,
                protyle,
                selectsElement,
                level: 2,
                type: "Blocks2Hs",
            ...
            turnIntoSubmenu.push(this.turnsInto({
                menuId: "heading3",
                icon: "iconH3",
                label: window.shehab.languages.heading3,
                accelerator: window.shehab.config.keymap.editor.heading.heading3.custom,
                protyle,
                selectsElement,
                level: 3,
                type: "Blocks2Hs",
            ...
            turnIntoSubmenu.push(this.turnsInto({
                menuId: "heading4",
                icon: "iconH4",
                label: window.shehab.languages.heading4,
                accelerator: window.shehab.config.keymap.editor.heading.heading4.custom,
                protyle,
                selectsElement,
                level: 4,
                type: "Blocks2Hs",
            ...
            turnIntoSubmenu.push(this.turnsInto({
                menuId: "heading5",
                icon: "iconH5",
                label: window.shehab.languages.heading5,
                accelerator: window.shehab.config.keymap.editor.heading.heading5.custom,
                protyle,
                selectsElement,
                level: 5,
                type: "Blocks2Hs",
            ...
            turnIntoSubmenu.push(this.turnsInto({
                menuId: "heading6",
                icon: "iconH6",
                label: window.shehab.languages.heading6,
                accelerator: window.shehab.config.keymap.editor.heading.heading6.custom,
                protyle,
                selectsElement,
                level: 6,
                type: "Blocks2Hs",
            ...
            window.shehab.menus.menu.append(new MenuItem({
                id: "turnInto",
                icon: "iconRefresh",
                label: window.shehab.languages.turnInto,
                type: "submenu",
            ...
            if (isContinue && !(selectsElement[0].parentElement.classList.contains("sb") &&
                ...
                window.shehab.menus.menu.append(new MenuItem({
                    id: "mergeSuperBlock",
                    icon: "iconSuper",
                    label: window.shehab.languages.merge + " " + window.shehab.languages.superBlock,
                    type: "submenu",
                    submenu: [this.turnsIntoOne({
                        menuId: "hLayout",
                        label: window.shehab.languages.hLayout,
                        accelerator: window.shehab.config.keymap.editor.general.hLayout.custom,
                        icon: "iconSplitLR",
                        protyle,
                        selectsElement,
                        ...
                        menuId: "vLayout",
                        label: window.shehab.languages.vLayout,
                        accelerator: window.shehab.config.keymap.editor.general.vLayout.custom,
                        icon: "iconSplitTB",
                        protyle,
                        selectsElement,
                        type: "BlocksMergeSuperBlock",
        ...
        if (!protyle.disabled) {
            window.shehab.menus.menu.append(new MenuItem({
                id: "ai",
                icon: "iconSparkles",
                label: window.shehab.languages.ai,
                accelerator: window.shehab.config.keymap.editor.general.ai.custom,
                click() {
        ...
        const copyMenu: IMenu[] = (copySubMenu(Array.from(selectsElement).map(item => item.getAttribute("data-node-id")), true, selectsElement[0]) as IMenu[]).concat([{
            id: "copyPlainText",
            iconHTML: "",
            label: window.shehab.languages.copyPlainText,
            accelerator: window.shehab.config.keymap.editor.general.copyPlainText.custom,
            click() {
                let html = "";
        ...
        if (!protyle.disabled) {
            ...
            window.shehab.menus.menu.append(new MenuItem({id: "separator_appearance", type: "separator"}).element);
            const appearanceElement = new MenuItem({
                id: "appearance",
                label: window.shehab.languages.appearance,
                icon: "iconFont",
                accelerator: window.shehab.config.keymap.editor.insert.appearance.custom,
                click: () => {
                    /// #if MOBILE
                    ...
                    protyle.toolbar.subElement.style.zIndex = (++window.shehab.zIndex).toString();
            ...
            window.shehab.menus.menu.append(appearanceElement);
            if (!isMobile()) {
        ...
        if (!window.shehab.config.readonly) {
            ...
            window.shehab.menus.menu.append(new MenuItem({
                ...
                label: allCardsMade ? window.shehab.languages.removeCard : window.shehab.languages.quickMakeCard,
            ...
            window.shehab.menus.menu.append(new MenuItem({
                ...
                icon: "iconRiffCard",
                ignore: !window.shehab.config.flashcard.deck,
                click() {
                    const ids: string[] = [];
    ...
    public renderMenu(protyle: IProtyle, buttonElement: Element) {
        ...
        if (selectsElement.length > 1) {
            window.shehab.menus.menu.element.setAttribute("data-name", Constants.MENU_BLOCK_MULTI);
            ...
            window.shehab.menus.menu.element.setAttribute("data-name", Constants.MENU_BLOCK_SINGLE);
        }
        ...
        const copyMenu = (copySubMenu([id], true, nodeElement) as IMenu[]).concat([{
            ...
            iconHTML: "",
            label: type === "NodeAttributeView" ? window.shehab.languages.copyMirror : window.shehab.languages.copy,
            accelerator: "⌘C",
            click() {
        ...
        if (type === "NodeAttributeView") {
            copyMenu.splice(6, 0, {
                iconHTML: "",
                label: window.shehab.languages.copyAVID,
                click() {
            ...
            if (!protyle.disabled) {
                copyMenu.push({
                    id: "duplicateMirror",
                    iconHTML: "",
                    label: window.shehab.languages.duplicateMirror,
                    accelerator: window.shehab.config.keymap.editor.general.duplicate.custom,
                    click() {
                ...
                copyMenu.push({
                    ...
                    iconHTML: "",
                    label: window.shehab.languages.duplicateCompletely,
                    accelerator: window.shehab.config.keymap.editor.general.duplicateCompletely.custom,
                    click() {
        ...
        if (type === "NodeSuperBlock" && !protyle.disabled) {
            ...
            window.shehab.menus.menu.append(new MenuItem({
                id: "cancelSuperBlock",
                label: window.shehab.languages.cancel + " " + window.shehab.languages.superBlock,
                accelerator: window.shehab.config.keymap.editor.general[isCol ? "hLayout" : "vLayout"].custom,
                async click() {
            ...
            window.shehab.menus.menu.append(new MenuItem({
                ...
                accelerator: window.shehab.config.keymap.editor.general[isCol ? "vLayout" : "hLayout"].custom,
                label: window.shehab.languages.turnInto + " " + window.shehab.languages[isCol ? "vLayout" : "hLayout"],
                click() {
            ...
            window.shehab.menus.menu.append(new MenuItem({id: "separator_code", type: "separator"}).element);
            ...
            window.shehab.menus.menu.append(new MenuItem({
                ...
                type: "submenu",
                icon: "iconCode",
                label: window.shehab.languages.code,
                submenu: [{
                    id: "md31",
                    iconHTML: "",
                    label: `<div class="fn__flex" style="margin-bottom: 4px"><span>${window.shehab.languages.md31}</span><span class="fn__space fn__flex-1"></span>
<input type="checkbox" class="b3-switch fn__flex-center"${linewrap === "true" ? " checked" : ((window.shehab.config.editor.codeLineWrap && linewrap !== "false") ? " checked" : "")}></div>`,
                    bind(element) {
                    ...
                    id: "md2",
                    iconHTML: "",
                    label: `<div class="fn__flex" style="margin-bottom: 4px"><span>${window.shehab.languages.md2}</span><span class="fn__space fn__flex-1"></span>
<input type="checkbox" class="b3-switch fn__flex-center"${ligatures === "true" ? " checked" : ((window.shehab.config.editor.codeLigatures && ligatures !== "false") ? " checked" : "")}></div>`,
                    bind(element) {
                        element.addEventListener("click", (event: MouseEvent & { target: HTMLElement }) => {
                            const inputElement = element.querySelector("input");
                            if (event.target.tagName !== "INPUT") {
                    ...
                    id: "md27",
                    iconHTML: "",
                    label: `<div class="fn__flex" style="margin-bottom: 4px"><span>${window.shehab.languages.md27}</span><span class="fn__space fn__flex-1"></span>
<input type="checkbox" class="b3-switch fn__flex-center"${linenumber === "true" ? " checked" : ((window.shehab.config.editor.codeSyntaxHighlightLineNum && linenumber !== "false") ? " checked" : "")}></div>`,
                    bind(element) {
                        element.addEventListener("click", (event: MouseEvent & { target: HTMLElement }) => {
                            const inputElement = element.querySelector("input");
                            if (event.target.tagName !== "INPUT") {
            ...
            window.shehab.menus.menu.append(new MenuItem({id: "separator_chart", type: "separator"}).element);
            const height = (nodeElement as HTMLElement).style.height;
            let html = nodeElement.outerHTML;
            window.shehab.menus.menu.append(new MenuItem({
                id: "chart",
                label: window.shehab.languages.chart,
                icon: "iconCode",
                submenu: [{
                    id: "height",
                    iconHTML: "",
                    type: "readonly",
                    label: `<div class="fn__flex"><input class="b3-text-field fn__flex-1" value="${height ? parseInt(height) : "420"}" step="1" min="148" style="margin: 4px 8px 4px 0" placeholder="${window.shehab.languages.height}"><span class="fn__flex-center">px</span></div>`,
                    bind: (element) => {
                    ...
                    id: "update",
                    label: window.shehab.languages.update,
                    icon: "iconEdit",
                    click() {
            ...
            if (cellElement) {
                window.shehab.menus.menu.append(new MenuItem({id: "separator_table", type: "separator"}).element);
                window.shehab.menus.menu.append(new MenuItem({
                    id: "table",
                    type: "submenu",
                    icon: "iconTable",
            ...
            window.shehab.menus.menu.append(new MenuItem({id: "separator_exportCSV", type: "separator"}).element);
            window.shehab.menus.menu.append(new MenuItem({
                id: "exportCSV",
                icon: "iconDatabase",
                label: window.shehab.languages.export + " CSV",
                click() {
            ...
            window.shehab.menus.menu.append(new MenuItem({
                ...
                click() {
                    useShell("showItemInFolder", path.join(window.shehab.config.system.dataDir, "storage", "av", nodeElement.getAttribute("data-av-id")) + ".json");
                }
            }).element);
        } else if ((type === "NodeVideo" || type === "NodeAudio") && !protyle.disabled) {
            window.shehab.menus.menu.append(new MenuItem({id: "separator_VideoOrAudio", type: "separator"}).element);
            window.shehab.menus.menu.append(new MenuItem({
                id: type === "NodeVideo" ? "assetVideo" : "assetAudio",
                type: "submenu",
                icon: type === "NodeVideo" ? "iconVideo" : "iconRecord",
                label: window.shehab.languages.assets,
                submenu: videoMenu(protyle, nodeElement, type)
            }).element);
        } else if (type === "NodeIFrame" && !protyle.disabled) {
            window.shehab.menus.menu.append(new MenuItem({id: "separator_IFrame", type: "separator"}).element);
            window.shehab.menus.menu.append(new MenuItem({
                id: "assetIFrame",
                type: "submenu",
                icon: "iconLanguage",
            ...
            window.shehab.menus.menu.append(new MenuItem({id: "separator_html", type: "separator"}).element);
            window.shehab.menus.menu.append(new MenuItem({
                id: "html",
                icon: "iconHTML5",
                label: "HTML",
            ...
            window.shehab.menus.menu.append(new MenuItem({id: "separator_blockEmbed", type: "separator"}).element);
            const breadcrumb = nodeElement.getAttribute("breadcrumb");
            window.shehab.menus.menu.append(new MenuItem({
                id: "blockEmbed",
                type: "submenu",
                icon: "iconSQL",
                label: window.shehab.languages.blockEmbed,
                submenu: [{
                    id: "refresh",
                    icon: "iconRefresh",
                    label: `${window.shehab.languages.refresh} SQL`,
                    click() {
                    ...
                    id: "update",
                    icon: "iconEdit",
                    label: `${window.shehab.languages.update} SQL`,
                    click() {
                        protyle.toolbar.showRender(protyle, nodeElement);
                    }
                }, {
                    ...
                    label: `<div class="fn__flex" style="margin-bottom: 4px"><span>${window.shehab.languages.embedBlockBreadcrumb}</span><span class="fn__space fn__flex-1"></span>
<input type="checkbox" class="b3-switch fn__flex-center"${breadcrumb === "true" ? " checked" : ((window.shehab.config.editor.embedBlockBreadcrumb && breadcrumb !== "false") ? " checked" : "")}></div>`,
                    bind(element) {
                        element.addEventListener("click", (event: MouseEvent & { target: HTMLElement }) => {
                            const inputElement = element.querySelector("input");
                            if (event.target.tagName !== "INPUT") {
                    ...
                    id: "headingEmbedMode",
                    label: window.shehab.languages.headingEmbedMode,
                    type: "submenu",
                    submenu: [{
                        id: "showHeadingWithBlocks",
                        label: window.shehab.languages.showHeadingWithBlocks,
                        iconHTML: "",
                        ...
                        label: window.shehab.languages.showHeadingOnlyTitle,
                        iconHTML: "",
                        ...
                        label: window.shehab.languages.showHeadingOnlyBlocks,
                        iconHTML: "",
                        ...
                        id: "default",
                        label: window.shehab.languages.default,
                        iconHTML: "",
        ...
        if (!protyle.options.backlinkData) {
            window.shehab.menus.menu.append(new MenuItem({
                id: "enter",
                accelerator: `${window.shehab.config.keymap.general.enter.custom ? updateHotkeyTip(window.shehab.config.keymap.general.enter.custom) + "/" : ""}${updateHotkeyAfterTip("⌘" + window.shehab.languages.click)}`,
                label: window.shehab.languages.enter,
                click: () => {
                    zoomOut({protyle, id});
                }
            }).element);
            window.shehab.menus.menu.append(new MenuItem({
                id: "enterBack",
                accelerator: window.shehab.config.keymap.general.enterBack.custom,
                label: window.shehab.languages.enterBack,
                click: () => {
            ...
            window.shehab.menus.menu.append(new MenuItem({
                id: "enter",
                accelerator: `${updateHotkeyTip(window.shehab.config.keymap.general.enter.custom)}/${updateHotkeyTip("⌘" + window.shehab.languages.click)}`,
        ...
        if (!protyle.disabled) {
            window.shehab.menus.menu.append(new MenuItem({
                id: "insertBefore",
                icon: "iconBefore",
                label: window.shehab.languages.insertBefore,
                accelerator: window.shehab.config.keymap.editor.general.insertBefore.custom,
                click() {
                    hideElements(["select"], protyle);
            ...
            window.shehab.menus.menu.append(new MenuItem({
                id: "insertAfter",
                icon: "iconAfter",
                label: window.shehab.languages.insertAfter,
                accelerator: window.shehab.config.keymap.editor.general.insertAfter.custom,
                click() {
                    hideElements(["select"], protyle);
                    countBlockWord([], protyle.block.rootID);
        ...
        window.shehab.menus.menu.append(new MenuItem({
            id: "jumpTo",
            type: "submenu",
            label: window.shehab.languages.jumpTo,
            submenu: [{
                id: "jumpToParentPrev",
                iconHTML: "",
                label: window.shehab.languages.jumpToParentPrev,
                accelerator: window.shehab.config.keymap.editor.general.jumpToParentPrev.custom,
                click() {
                    hideElements(["select"], protyle);
                ...
                iconHTML: "",
                id: "jumpToParentNext",
                label: window.shehab.languages.jumpToParentNext,
                accelerator: window.shehab.config.keymap.editor.general.jumpToParentNext.custom,
                click() {
                    hideElements(["select"], protyle);
                ...
                iconHTML: "",
                id: "jumpToParent",
                label: window.shehab.languages.jumpToParent,
                accelerator: window.shehab.config.keymap.editor.general.jumpToParent.custom,
                click() {
                    hideElements(["select"], protyle);
        ...
        if (type !== "NodeThematicBreak") {
            window.shehab.menus.menu.append(new MenuItem({
                id: "fold",
                label: window.shehab.languages.fold,
                accelerator: `${updateHotkeyTip(window.shehab.config.keymap.editor.general.collapse.custom)}/${updateHotkeyTip("⌥" + window.shehab.languages.click)}`,
                click() {
        ...
        if (window.shehab.config.cloudRegion === 0 &&
            ...
            window.shehab.menus.menu.append(new MenuItem({
                ...
                ignore: window.shehab.config.readonly,
                click() {
                    openWechatNotify(nodeElement);
                }
            }).element);
        }
        if (type !== "NodeThematicBreak" && !window.shehab.config.readonly) {
            ...
            window.shehab.menus.menu.append(new MenuItem({id: "separator_5", type: "separator"}).element);
        }
        ...
        if (updateHTML) {
            updateHTML = `${window.shehab.languages.modifiedAt} ${dayjs(updateHTML).format("YYYY-MM-DD HH:mm:ss")}<br>`;
        }
        window.shehab.menus.menu.append(new MenuItem({
            id: "updateAndCreatedAt",
            iconHTML: "",
            type: "readonly",
            label: `${updateHTML}${window.shehab.languages.createdAt} ${dayjs(id.substr(0, 14)).format("YYYY-MM-DD HH:mm:ss")}`,
        }).element);
        return window.shehab.menus.menu;
    }
    ...
    private genAlign(nodeElements: Element[], protyle: IProtyle) {
        window.shehab.menus.menu.append(new MenuItem({
            ...
            submenu: [{
                id: "alignLeft",
                icon: "iconAlignLeft",
                label: window.shehab.languages.alignLeft,
                accelerator: window.shehab.config.keymap.editor.general.alignLeft.custom,
                click: () => {
                ...
                label: window.shehab.languages.alignCenter,
                accelerator: window.shehab.config.keymap.editor.general.alignCenter.custom,
                click: () => {
                    this.genClick(nodeElements, protyle, (e: HTMLElement) => {
                        if (e.classList.contains("av")) {
                ...
                id: "alignRight",
                icon: "iconAlignRight",
                label: window.shehab.languages.alignRight,
                accelerator: window.shehab.config.keymap.editor.general.alignRight.custom,
                click: () => {
                    this.genClick(nodeElements, protyle, (e: HTMLElement) => {
                        if (e.classList.contains("av")) {
                ...
                id: "justify",
                icon: "iconMenu",
                label: window.shehab.languages.justify,
                click: () => {
                    this.genClick(nodeElements, protyle, (e: HTMLElement) => {
                ...
                id: "ltr",
                icon: "iconLtr",
                label: window.shehab.languages.ltr,
                accelerator: window.shehab.config.keymap.editor.general.ltr.custom,
                click: () => {
                    this.genClick(nodeElements, protyle, (e: HTMLElement) => {
                ...
                id: "rtl",
                icon: "iconRtl",
                label: window.shehab.languages.rtl,
                accelerator: window.shehab.config.keymap.editor.general.rtl.custom,
                click: () => {
                    this.genClick(nodeElements, protyle, (e: HTMLElement) => {
                        if (!e.classList.contains("av")) {
                ...
                id: "clearFontStyle",
                icon: "iconTrashcan",
                label: window.shehab.languages.clearFontStyle,
                click: () => {
                    this.genClick(nodeElements, protyle, (e: HTMLElement) => {
                        if (e.classList.contains("av")) {
                            e.style.justifyContent = "";
    ...
    private genWidths(nodeElements: Element[], protyle: IProtyle) {
        ...
        const styles: IMenu[] = [{
            ...
            iconHTML: "",
            type: "readonly",
            label: `<div class="fn__flex"><input class="b3-text-field fn__flex-1" value="${firstElement.style.width.endsWith("px") ? parseInt(firstElement.style.width) : ""}" type="number" style="margin: 4px 8px 4px 0" placeholder="${window.shehab.languages.width}"><span class="fn__flex-center">px</span></div>`,
            bind: (element) => {
                const inputElement = element.querySelector("input");
        ...
        window.shehab.menus.menu.append(new MenuItem({
            id: "width",
            label: window.shehab.languages.width,
            submenu: styles.concat([{
                id: "widthDrag",
                iconHTML: "",
                type: "readonly",
                label: `<div style="margin: 4px 0;" aria-label="${firstElement.style.width.endsWith("px") ? firstElement.style.width : (firstElement.style.width || window.shehab.languages.default)}" class="b3-tooltips b3-tooltips__n"><input style="box-sizing: border-box" value="${width}" class="b3-slider fn__block" max="100" min="1" step="1" type="range"></div>`,
                bind: (element) => {
    ...
    private genHeights(nodeElements: Element[], protyle: IProtyle) {
        ...
        const styles: IMenu[] = [{
            ...
            iconHTML: "",
            type: "readonly",
            label: `<div class="fn__flex"><input class="b3-text-field fn__flex-1" value="${firstElement.style.height.endsWith("px") ? parseInt(firstElement.style.height) : ""}" type="number" style="margin: 4px 8px 4px 0" placeholder="${window.shehab.languages.height}"><span class="fn__flex-center">px</span></div>`,
            bind: (element) => {
                const inputElement = element.querySelector("input");
                inputElement.addEventListener("input", () => {
                    nodeElements.forEach((item: HTMLElement) => {
        ...
        window.shehab.menus.menu.append(new MenuItem({
            id: "heightDrag",
            label: window.shehab.languages.height,
            submenu: styles.concat([{
                iconHTML: "",
                type: "readonly",
                label: `<div style="margin: 4px 0;" aria-label="${firstElement.style.height.endsWith("px") ? firstElement.style.height : (firstElement.style.height || window.shehab.languages.default)}" class="b3-tooltips b3-tooltips__n"><input style="box-sizing: border-box" value="${height}" class="b3-slider fn__block" max="100" min="1" step="1" type="range"></div>`,
                bind: (element) => {
                    rangeElement = element.querySelector("input");
                    rangeElement.addEventListener("input", () => {
                        nodeElements.forEach((e: HTMLElement) => {
    ...
    private genCopyTextRef(selectsElement: Element[]): false | IMenu {
        ...
        return {
            id: "copyText",
            iconHTML: "",
            accelerator: window.shehab.config.keymap.editor.general.copyText.custom,
            label: window.shehab.languages.copyText,
            click() {
                // 用于标识复制文本 *
            ...
            if (!isInEmbedBlock(nodeElement)) {
                ...
                if (type === "NodeAttributeView" && target) {
                    ...
                    if (rowElement && !rowElement.classList.contains("av__row--header") && rowElement.dataset.id) {
                        ...
                        let iconAriaLabel = isMac() ? window.shehab.languages.rowTip : window.shehab.languages.rowTip.replace("⇧", "Shift+");
                        if (protyle.disabled) {
                            iconAriaLabel = window.shehab.languages.rowTip.substring(0, window.shehab.languages.rowTip.indexOf("<br"));
                        } else if (rowElement.querySelector('[data-dtype="block"]')?.getAttribute("data-detached") === "true") {
                            iconAriaLabel = window.shehab.languages.rowTip.substring(0, window.shehab.languages.rowTip.lastIndexOf("<br"));
                        }
                        ...
                        if (!protyle.disabled) {
                            html = `<button data-type="NodeAttributeViewRow" data-node-id="${dataNodeId}" data-row-id="${rowElement.dataset.id}" data-group-id="${bodyElement.dataset.groupId || ""}" class="ariaLabel" data-position="parentW" aria-label="${isMac() ? window.shehab.languages.addBelowAbove : window.shehab.languages.addBelowAbove.replace("⌥", "Alt+")}"><svg><use xlink:href="#iconAdd"></use></svg></button>${html}`;
                        }
                        break;
                    }
                }
...
data-type="${type}" data-subtype="${nodeElement.getAttribute("data-subtype")}" data-node-id="${dataNodeId}">
    ...
    <span ${popoverHTML} ${protyle.disabled ? "" : 'draggable="true"'}></span>
                ...
                if (type === "NodeListItem" && nodeElement.childElementCount > 3 || type === "NodeHeading") {
                    ...
                    foldHTML = `<button class="ariaLabel" data-position="parentW" aria-label="${window.shehab.languages.fold}" 
data-type="fold" style="cursor:inherit;"><svg style="width: 10px${fold && fold === "1" ? "" : ";transform:rotate(90deg)"}"><use xlink:href="#iconPlay"></use></svg></button>`;
        ...
        let marginHeight = 0;
        if (listItem && !window.shehab.config.editor.rtl && getComputedStyle(element).direction !== "rtl" &&
            // 提示下有列表
            ...
            if (rect.height < Math.floor(window.shehab.config.editor.fontSize * 1.625) + 8 ||
                (rect.height > Math.floor(window.shehab.config.editor.fontSize * 1.625) + 8 && rect.height < Math.floor(window.shehab.config.editor.fontSize * 1.625) * 2 + 8)) {
